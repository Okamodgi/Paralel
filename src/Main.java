...
public class Main {
    ...
    private static void sequentialProcess(int[] vector, int multiplier) {
        for (int i = 0; i < vector.length; i++) {
            vector[i] = vector[i] * multiplier;
        }
    }

    private static void multithreadedProcess(int[] vector, int multiplier, int numThreads) throws InterruptedException {
